...
@command("lart", aliases=(), doc="Luser Attitude Readjustment Tool")
def lart(client, event, channel, nick, rest):
    lart_opts = ['accelerates a free AOL cd to 50,000 rpm and lets WHO feel it',
        ...
        'brandishes Excalibur! "With this sword, I vanquish thee, WHO!" and lops off %s\'s head',
    ...
    lart = lart_opts[i]
    response = lart.replace("WHO",target)
    return response
